...
# Incluir en df 
final_df_order <- data.frame(final_df_order,dummies_unittype[,2:8])
...
final_df_order <- rename(final_df_order,rename(apacheadmissiondx_abscess_neurologic = .data_Abscess..neurologic )%>%
                           ...
                           rename(apacheadmissiondx_preumonia_bacterial = .data_Pneumonia..bacterial) %>%
                           rename(apacheadmissiondx_pneumonia_fungal = .data_Pneumonia..fungal) %>%
                           rename(apacheadmissiondx_pnenumonia_other = .data_Pneumonia..other) %>%
                           rename(apacheadmissiondx_penumonia_parasitic = .data_Pneumonia..parasitic..i.e...Pneumocystic.pneumonia.) %>%
                           rename(apacheadmissiondx_penumonia_viral = 	.data_Pneumonia..viral) %>%
