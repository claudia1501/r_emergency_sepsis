...
# Calcula el porcentaje de pacientes con apacheadmission y al menos un vasopresor aplicado
porcentaje <- final_df_order %>%
  group_by(patientunitstayid) %>%
  summarize(porcentaje = mean(apacheadmissiondx & al_menos_un_vasopresor) * 100)
