...
#Pasar las variables en formato horas a minutos
```{r}

```


#Variable dependiente = hospitaldischargestatus
```{r}
...
final_df_order <- final_df %>%
  select(patientunitstayid, patienthealthsystemstayid, gender_numeric, age_numeric,ethnicity,hospitalid, wardid,apacheadmissiondx,admissionheight,hospitaladmittime24,hospitaladmitoffset,hospitaladmitsource,hospitaldischargeyear,hospitaldischargetime24,hospitaldischargeoffset,hospitaldischargelocation, hospitaldischargestatus, unittype, unitadmittime24, unitadmitsource,unitvisitnumber,unitstaytype,admissionweight,dischargeweight,unitdischargetime24,unitdischargeoffset,unitdischargelocation, unitdischargestatus,uniquepid, microlabid,culturetakenoffset, culturesite, organism,antibiotic, sensitivitylevel)
```
...
>>>>>>> de90fe562691e8c24a8e4e0b63e6bd59821ad2a6
