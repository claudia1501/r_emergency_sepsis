...
```
##variable admissionheight
```{r}
# Crear un dataframe de datos con valores NA en 'admissionheight' a predecir
df_to_predict_admissionheight <- final_df_order[is.na(final_df_order$admissionheight), ]

# Utilizar el modelo para predecir los valores faltantes
predictions_admissionheight <- predict(model, newdata = df_to_predict_admissionheight)

# Asignar las predicciones a las filas correspondientes en final_df_order
final_df_order$admissionheight [is.na(final_df_order$admissionheight)] <- predictions_admissionheight
```
