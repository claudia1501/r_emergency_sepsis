...
vars_in_table1 <- names(final_df_order %>% select(gender_numeric, age_numeric,ethnicity,hospitalid,apacheadmissiondx,admissionheight,lengthofstay,hospitaladmitsource,hospitaldischargeoffset, hospitaldischargestatus, unittype,unitadmitsource,unitstaytype,admissionweight,dischargeweight,unitdischargeoffset,unitdischargestatus,culturetakenoffset,organism,antibiotic,sensitivitylevel,max_apachescore))
```
