...
vars_in_table1 <- names(final_df_er_sepsis %>% select(unitdischargestatus,er_los_hrs, sex, age, ethnicity, apachescoreIV, final_charlson_score,apacheadmissiondx, vasopressors))
