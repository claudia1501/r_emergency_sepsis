...
vars_in_table1 <- names(final_df_order %>% select(gender, age,ethnicity,hospitalid,er_los,sepsis_bin,infection_bin, apacheadmissiondx,hospitaladmitsource,hospitaldischargeoffset, unittype,unitdischargeoffset,apachescoreIV,sensitivity_level,unitdischargestatus))
```
...
```{r}
table1_base %>%
  kbl(caption = "Table 1 Emergency and sepsis. Stratify by mortality", align = "c") %>%
