...
vars_in_table1 <- names(final_df_order %>% select(sex, age,ethnicity,hospitalid,er_los_hrs,sepsis_bin,infection_bin, apacheadmissiondx,hospitaldischargeoffset, unittype,unitdischargeoffset,apachescoreIV,bact_resist_level,unitdischargestatus))
```
...
write.csv(table1_dataset, file = "C:/Users/cjimenez10J/Documents/projects/r_urgencias_sepsis/r_urgencias_sepsis/Figures/selected_data.csv", row.names = FALSE)

write.csv(final_df_order, file = "C:/Users/cjimenez10J/Documents/projects/r_urgencias_sepsis/r_urgencias_sepsis/Figures/selected_data.csv", row.names = FALSE)
```
