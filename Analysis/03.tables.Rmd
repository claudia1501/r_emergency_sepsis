...
vars_in_table1 <- names(final_df_order %>% select(gender_num, age_num,lengthofstay,ethnicity,apacheadmissiondx,hospitaladmitsource,hospitaldischargeoffset, hospitaldischargestatus, unittype,unitdischargestatus,culturetakenoffset,sensitivitylevel,max_apachescore))
```
