...
vars_in_table1 <- names(final_df_order %>% select(gender, age,ethnicity,hospitalid,er_los_H,sepsis_bin,infection_bin, apacheadmissiondx,hospitaladmitsource,hospitaldischargeoffset, unittype,unitdischargeoffset,apachescoreIV,sensitivity_level,unitdischargestatus))
```
...
write.csv(table1_base, file = "C:/Users/cjimenez10J/Documents/projects/r_urgencias_sepsis/r_urgencias_sepsis/Figures/selected_data.csv", row.names = FALSE)
```
