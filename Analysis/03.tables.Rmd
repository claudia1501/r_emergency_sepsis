...
vars_in_table1 <- names(final_df_order %>% select(gender, age,ethnicity,hospitalid,er_los,sepsis_bin,infection_bin, apacheadmissiondx,hospitaladmitsource,hospitaldischargeoffset, unittype,unitdischargeoffset,apachescoreIV,unitdischargestatus))
```
