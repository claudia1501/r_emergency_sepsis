...
dummies_bact_resist_level <- dummy_cols(final_df_er_sepsis$bact_resist_level, remove_first_dummy = FALSE)
...
final_df_er_sepsis <- data.frame(final_df_er_sepsis, dummies_bact_resist_level[,2:4],dummies_unittype[,2:8],dummies_ethnicity[,2:7],dummies_apacheadmissiondx[,2:12])
```
#Creating functions
```{r}
# Metric performance
