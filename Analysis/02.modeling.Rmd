...
linear_model <- gam(unitdischargestatus ~ 
                      sex + 
                      age + 
                      ethnicity + 
                      apachescoreIV +  
...
## Ordenación de variables y asignación de nombres adecuados
variables_order <- rev(c(
  "Intercept", "Tiempo de ingreso en UCI (horas)", "Sex (Male)", "Age (years)", "Ethnicity", "ApachescoreIV", "Final Charlson Score" # "Renal History", "Cancer History", "CHF History", "COPD History", "Other History"
))
